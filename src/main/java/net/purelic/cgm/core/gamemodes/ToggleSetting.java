...
public enum ToggleSetting implements GameSetting {
    ...
    INFECTED_HELMET_LOCKED(GameSettingType.PLAYER_HELMET, true),
    INFECTED_CHESTPLATE_LOCKED(GameSettingType.PLAYER_CHESTPLATE, true),
    INFECTED_LEGGINGS_LOCKED(GameSettingType.PLAYER_LEGGINGS, true),
    INFECTED_BOOTS_LOCKED(GameSettingType.PLAYER_BOOTS, true),

    INFECTED_SWORD_LOCKED(GameSettingType.PLAYER_SWORD, true),
    INFECTED_SWORD_INSTANT_KILL(GameSettingType.PLAYER_SWORD, false),
