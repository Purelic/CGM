...
public enum NumberSetting implements GameSetting {
    ...
    INFECTED_CHESTPLATE_PROT(GameSettingType.INFECTED_CHESTPLATE, 0),
    ...
    PLAYER_BOOTS_PROJ_PROT(GameSettingType.PLAYER_BOOTS, 1),
    ...
    INFECTED_BOOTS_PROJ_PROT(GameSettingType.INFECTED_BOOTS, 1),
