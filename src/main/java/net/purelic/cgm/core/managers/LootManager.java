...
public class LootManager {
    ...
    public static void setLootItems() {
        List<LootChestItem> swNormalItems = Arrays.asList(
            ...
            new LootChestItem(LootItemLevel.LEVEL_5, new ItemCrafter(Material.FISHING_ROD).durability(61)),
            ...
            new LootChestItem(LootItemLevel.LEVEL_8, new ItemCrafter(Material.FLINT_AND_STEEL).durability(61)),
            new LootChestItem(LootItemLevel.LEVEL_9, new ItemCrafter(Material.FLINT_AND_STEEL).durability(61)),
        ...
        List<LootChestItem> sgNormalItems = Arrays.asList(
            ...
            new LootChestItem(LootItemLevel.LEVEL_10, new ItemCrafter(Material.FLINT_AND_STEEL).durability(61)),
            new LootChestItem(LootItemLevel.LEVEL_10, new ItemCrafter(Material.FISHING_ROD).durability(61)),
